...
=== Encoding space
* *RISC-DSP-w reuses the extension space of RVV (Func7 encoding space 1010111)*
+
.RVV overall table
...
|=============================================================================================================
+
* *RISC-DSP-w follow the same Func3 encoding law of RVV*
+
...
+
* *RISC-DSP-w  Func6 encoding space in RVV*
+
.RISC-DSP-w Func6 encoding table part 1
...
| 001000 |   |   | I | *_fft_/_vfcvt_* | 001000 | V | X | vaaddu      | 001000 | V | F | vfsgnj      
...
|=================================================================================================
+
.RISC-DSP-w Func6 encoding table part 2
[cols="13*", options="header"]
|==============================================================================================
5+| funct6 4+| funct6 4+| funct6               
...
| 011010 |   |   | I | vmget      | 011010 |   |   |             | 011010 |   |   |             
| 011011 | V | X |   | vmslt      | 011011 | V |   | vmxor       | 011011 | V | F | vmflt
| 011011 |   |   | I | vmset      | 011011 |   |   |             | 011011 |   |   |        
...
|==============================================================================================
+
.RISC-DSP-w Func6 encoding table part 3
[cols="13*", options="header"]
|========================================================================================
5+| funct6 4+| funct6 4+| funct6          
...
|========================================================================================
+
.RISC-DSP-w Func6 encoding table part 4
[cols="13*", options="header"]
|===========================================================================================
5+| funct6 4+| funct6 4+| funct6         
...
=== RISC-DSP-w Instruction encoding
- *RISC-DSP-w Instruction encoding*
+
.RISC-DSP-w encoding table
...
| vfft.type.v vd,vs2              | 001000 | 1  | vs2   | type        | 011   | vd     | 1010111
| vfcvt.type.v vd,vs2             | 001000 | 1  | vs2   | type        | 011   | vd     | 1010111
...
| vmget.v v0                      | 011010 | 1  | 00000 | 00000       | 011   | 00000  | 1010111
| vmset.v v0                      | 011011 | 1  | 00000 | 00000       | 011   | 00000  | 1010111
|===============================================================================================
+
- *RISC-DSP-w Load & Store Instruction encoding*
+
.RISC-DSP-w load & store instruction encoding table
[cols="8*", options="header"]
|=========================================================================================
